...
if __name__ == '__main__':
	...
	earlystop = EarlyStopping(patience=5, mode='auto')

	model.fit(x_train, y_train, epochs = 150, batch_size = 10, callbacks=[model_checkpoint], validation_data=(x_test, y_test))
